...
#python train_net.py --config-file /home/nkombol/fcclip/fc-clip/configs/coco/panoptic-segmentation/fcclip/fcclip_convnext_large_eval_ade20k.yaml --eval-only MODEL.WEIGHTS /home/nkombol/fcclip_cocopan.pth
#python train_net.py --num-gpus 2  --config-file /home/nkombol/fcclip/fc-clip/configs/coco/panoptic-segmentation/fcclip/fcclip_convnext_large_eval_ade20k.yaml
def add_fcclip_config(cfg):
    ...
    cfg.MODEL.FC_CLIP.NUM_DECODER_LAYER = 1
    cfg.MODEL.FC_CLIP.DECODER_MASK_FEATURE = False
